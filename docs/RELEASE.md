...
10. Extend a timed session by 30 minutes, then stop it. Confirm the countdown disappears; indefinite sessions must disable the extension action.
...
12. Use `scripts/stay-awake-toggle` to stop a timed session and start an indefinite one. Confirm the menu follows the process and does not show the old countdown.
